...
custom_description: My personal website.
---
{% include common-links-abbreviations.md %}

<figure style="display: block">
  {%- comment -%}<!-- -webkit-clip-path is for iOS Safari -->{%- endcomment -%}
  <img src="{% link /assets/img/face.jpg %}" alt="Me" style="clip-path: circle(44.2% at 50% 50%); -webkit-clip-path: circle(44.2% at 50% 50%); width: 14em; height: auto; display: block; margin-left: auto; margin-right: auto;">
  <figcaption>2019, November</figcaption>
</figure>
...
`Bio` | I was born in Mogilev, Belarus, moved to Moscow, Russia, where I studied at [MIPT]. Then I was a researcher in [GPI RAS], where I got a **Ph.D in Condensed Matter Physics**. 
